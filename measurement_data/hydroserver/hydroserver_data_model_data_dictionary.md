...
DWRi uses HydroServer for storing and managing time series of metasurement data for diversions and other measurement stations located throughout the State of Utah. [HydroServer](http://www.hydroserver.org/) is an open-source software system designed to enable collection, storage, management, and sharing of time series data collected using or derived from environmental sensors. HydroServer operates on top of a relational database that stores time series data using [PostgreSQL](https://www.postgresql.org/). For very large database instances, PostgreSQL's [TimescaleDB extension](https://github.com/timescale/timescaledb) can be used to enhance performance, but is not required. Here we document the relational data model used by the HydroServer software for storing time series data.
...
<img src="images/hydroserver_data_model.png" alt="HydroServer Data Model" width="200"/>
...
<img src="images/ogc_sensorthings_data_model.png" alt="OGC SensorThings Data Model" width="200"/>
...
<img src="images/odm_time_series_information_model.png" alt="ODM Time Series Information Model" width="200"/>
